        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>I may be posting a "Snack List", so we know who is responsible for half-time oranges and beer after the game. Most likely, it'll have Florin's name for each week. =)</p>

                    <img src="/img/florin.png" class="d-block mt-3 mr-auto ml-auto" />
                    <h4 class="text-center">
                        SnackMaster
                    </h4>

                    <p>Looking for the official league website? </p>

                    <a href="http://www.diablosoccer.org/sites/dasl/schedule/183380/Spring-DASL-Division-C" target="_blank" class="btn btn-primary btn-block">
